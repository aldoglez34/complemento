  ...
  return (
    <Layout>
      <Container className="my-4">
        ...
        <p>
          Ponte en contacto con nosotros. ¿Necesitas ayuda en una compra?
          ¿Tienes alguna duda sobre un precio? ¿No encontraste el producto que
          buscabas? Escríbenos por este medio y nos pondremos en contacto
          contigo al correo proporcionado.
        </p>
        <Formik
          initialValues={{
            name: "",
