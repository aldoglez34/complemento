    ...
    <Layout>
      <Container className="my-4">
        ...
        <p>
          ...
          <strong>www.tucomplemento.com</strong> (en adelante, "SITIO WEB"), del
          cual es titular (en adelante, "TITULAR"). Cualquier persona que desee
          acceder o hacer uso del sitio o los servicios que en él se ofrecen,
          podrá hacerlo sujetándose a los presentes TÉRMINOS Y CONDICIONES, así
          como a políticas y principios incorporados al presente documento. En
          todo caso, cualquier persona que no acepte los presentes términos y
        ...
        <div id="texte_a_afficher" className="texte_inselectionnable">
          ...
          <p>
            ...
            <strong>
              <span id="span_id_el_sitio" className="encours">
                www.tucomplement.com
              </span>
            </strong>{" "}
            (en adelante, "SITIO WEB"), del cual es titular{" "}
            <strong>
              <span id="span_id_el_propietario" className="encours">
                <span className="variable_vide">________</span>
              </span>
            </strong>{" "}
            (en adelante, "TITULAR"). Cualquier persona que desee acceder o
            hacer uso del sitio o los servicios que en él se ofrecen, podrá
            hacerlo sujetándose a los presentes TÉRMINOS Y CONDICIONES, así como
            a políticas y principios incorporados al presente documento. En todo
          ...
          <p>
            ...
            cualquiera de los elementos que conforman el SITIO WEB o el acceso a
            los mismos.
          </p>
          <p>
          ...
          <p>
            ...
            la República Mexicana, por lo cual,{" "}
            <strong>
              <span id="span_id_el_propietario" className="encours">
                <span className="variable_vide">________</span>
              </span>
            ...
            utilizar el SITIO WEB lo hará bajo su propia responsabilidad y
          ...
          <p>
            ...
            no será responsable ni garantiza que el contenido o software al que
            pueda accederse a través del SITIO WEB, se encuentre libre de
            errores, software malicioso, o que pueda causar algún daño a nivel
            de software o hardware en el equipo a través del cual el USUARIO
            accede al SITIO WEB.
          </p>
          <p>
          ...
          <p>
            ...
            no asume ningún tipo de responsabilidad por los datos que san
            facilitados por el USUARIO a través de cualquier sitio web distinto
            a{" "}
            <strong>
              <span id="span_id_el_sitio" className="encours">
                www.tucomplement.com
          ...
          <p>
            ...
            o invitación para hacer uso de sitios externos.{" "}
            <strong>
              <span id="span_id_el_propietario" className="encours">
                <span className="variable_vide">________</span>
              </span>
            </strong>{" "}
            en ningún caso revisará o controlará el contenido de los sitios
            externos, de igual forma, no hace propios los productos, servicios,
            contenidos, y cualquier otro material existente en los referidos
            sitios enlazados; por lo cual, tampoco se garantizará la
            ...
            daños y perjuicios que pudieran producirse por el acceso o uso, de
            los contenidos, productos o servicios disponibles en los sitios web
            no gestionados por{" "}
            <strong>
              <span id="span_id_el_propietario" className="encours">
                <span className="variable_vide">________</span>
          ...
          <p>
            <span className="flou">
              228 55588585 2 22582528 852 52588822 2 258888522 52 228582 828
              52852 525 252825 828 2522525, 5 2822 55558 258 5282552 22255 22
              852225 82 882582222:
            </span>
          </p>
          <p>
            <span className="flou">
              82 82 2252822 85 522525588822 (22258 2 2558858) 52 828 8222228528,
              252558228 2 825888828 58822288828 22 28 55558 258 882 85
              552258258822 2525285 52{" "}
              <strong>
                <span id="span_id_el_propietario" className="encours">
                  <span className="variable_vide">________</span>
                </span>
              </strong>{" "}
              2 85 2825855. 5522282 82 2252828552 252822825882228 258858,
              822558258 2 82825528258 82852 28 55558 258, 28 82852 858
              8222228528, 252558228 2 825888828, 25582252{" "}
              <strong>
                <span id="span_id_el_propietario" className="encours">
                  <span className="variable_vide">________</span>
                </span>
              </strong>{" "}
              5282582285 28 588282 58 55558 258 5 2255 5852885 2258225 852
              8285555 22 2822 2822 52 58228.
            </span>
          </p>
          <p>
            <span className="flou">
              58 282588288282222 52 52 228582 58 55558 258 52852 855885825 88282
              2522522, 22 822888555 85 2588222885 52 582525 52858822 22252{" "}
              <strong>
                <span id="span_id_el_propietario" className="encours">
                  <span className="variable_vide">________</span>
                </span>
              </strong>{" "}
              2 28 2825855 528 88282 828 52852 28 8558 82 5258882, 2522282
              822888555 28 822288282222 52{" "}
              <strong>
                <span id="span_id_el_propietario" className="encours">
                  <span className="variable_vide">________</span>
                </span>
              </strong>{" "}
              52 828 8222228528, 252558228 2 825888828 225288528 22 828 882828
              25225228 52852 828 855828 82 25255 5882525 58 55558 258.
            </span>
          </p>
          <p>
            <strong>
          ...
          <p>
            ...
            a través de los datos de contacto disponibles en el propio SITIO
            WEB.{" "}
          </p>
          <p>
          ...
          <p>
            ...
            se regirá por la legislación vigente en México, específicamente en{" "}
            <span id="span_id_estado_del_domicilio_del_propietario">
              Aguascalientes
            </span>
            . De surgir cualquier controversia en relación a la interpretación
            y/o a la aplicación de los presentes TÉRMINOS Y CONDICIONES, las
            partes se someterán a la jurisdicción ordinaria de los tribunales
            que correspondan conforme a derecho en el estado al que se hace
            referencia.
          </p>
        </div>
      </Container>
